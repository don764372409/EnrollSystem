...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-sm-9">
			<input type="text" class="input-text" onkeyup="createUsername(this)" value="${obj.name}" placeholder="请输入管理员姓名" name="name">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-sm-9">
			<input type="text" class="input-text" onkeyup="value=value.replace(/[^\d]/g,'')" value="${obj.phone}" placeholder="请输入管理员电话" name="phone">
		</div>
	</div>
	<div class="row cl">
