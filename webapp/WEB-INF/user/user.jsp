...
<!--   </div> -->
  <div class="cl pd-5 bg-1 bk-gray mt-20">
	     <span class="l">
		 	...
		 	ID:<input type="text" id="ID"> 姓名:<input type="text" id="name"> VIP:<input type="text" id="vip"><input type="button" onclick="serch()" value="搜索">
    	</span>
...
function serch(){
	...
	location.href="http://localhost:8080/user?cmd=select&id="+id+"&name="+name+"&vip="+vip;
// 	var index = layer.open({
// 		type: 2,
// 		title: title,
// 		content: url
